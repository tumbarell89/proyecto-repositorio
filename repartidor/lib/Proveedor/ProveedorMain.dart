...
class ProveedorMain extends StatefulWidget {
  //const ProveedorMain({super.key});

  @override
  State<ProveedorMain> createState() => _ProveedorMainState();
}

class _ProveedorMainState extends State<ProveedorMain> {
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: Container(
                  ...
                  onPressed: () {print('hola acceso proveedor');  })
                ),
              ),
              Divider(height: 20.0),
              SizedBox(
                ...
                child: Container(
                  ...
                  onPressed: () {print('hola registro proveedor');  })
                ),
